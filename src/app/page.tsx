    ...
    <>
      <div className='flex'>
        ...
        <div className='flex flex-col gap-5 bg-[#c4e0eb] p-4 rounded-bl-none rounded-tr-none'>
          ...
          <section className='grid w-full grid-cols-1 gap-8 items-center lg:flex'>
            <div className='flex gap-5 lg:flex-col '>
              <div className='shadow-md w-44 h-28 p-3 rounded-lg bg-[#d3e5ed]'>
            ...
            <div className='w-full shadow-lg rounded-lg bg-[#d3e5ed]'>
